...
-- 初始化数据 - post表
-- ----------------------------
INSERT INTO `post`(`pid`, `ptitle`, `pbody`, `psendtime`, `lastreplytime`, `uid`, `category`, `is_sticky`) VALUES
(1, 'Spring Boot入门教程', 'Spring Boot是一个快速开发框架，可以大大简化Spring应用的搭建过程。本文将介绍Spring Boot的基本概念和快速入门方法。', '2020-08-12 10:57:45', '2020-08-15 16:30:00', 1, '技术', 1),
(2, 'MySQL性能优化技巧', '分享一些MySQL数据库性能优化的实用技巧，包括索引优化、查询优化、配置调优等方面。', '2020-08-13 11:20:15', '2020-08-14 09:45:30', 2, '技术', 1),
(3, '前端框架对比：React vs Vue', '详细对比React和Vue这两个热门前端框架的优缺点，帮助开发者选择合适的工具。', '2020-08-14 15:30:45', '2020-08-15 10:20:15', 3, '技术', 0),
(4, '最近看的好电影推荐', '最近看了几部不错的电影，想和大家分享一下。《流浪地球2》真的很震撼，特效和剧情都很棒！', '2020-08-13 20:15:30', '2020-08-14 22:10:45', 2, '娱乐', 0),
(5, '推荐几首好听的歌曲', '分享一些最近单曲循环的歌曲，有民谣、摇滚、流行等各种风格，希望大家喜欢。', '2020-08-14 18:45:20', '2020-08-15 19:30:10', 4, '娱乐', 0),
(6, '家常红烧肉的做法', '分享一道经典的家常菜红烧肉的制作方法，简单易学，味道鲜美，适合初学者尝试。', '2020-08-14 12:30:15', '2020-08-15 14:20:30', 3, '美食', 0),
(7, '推荐几家好吃的火锅店', '在北京工作生活了几年，踩过不少坑，也发现了不少宝藏店铺。今天推荐几家个人觉得不错的火锅店。', '2020-08-15 13:45:40', '2020-08-15 21:15:25', 2, '美食', 0),
(8, '云南大理三日游攻略', '刚从大理回来，景色真的很美！给大家分享一份详细的三日游攻略，包括路线规划、必去景点、美食推荐等。', '2020-08-15 09:20:30', '2020-08-15 17:45:15', 4, '旅游', 0),
(9, '西藏旅行注意事项', '计划去西藏旅行的朋友们注意了，这里有一些重要的注意事项和准备工作，确保旅途安全顺利。', '2020-08-15 16:30:45', '2020-08-15 20:10:20', 1, '旅游', 0),
(10, '新手求助：Java环境配置问题', '刚开始学习Java，在配置开发环境时遇到了一些问题，JDK安装后环境变量设置总是出错，求大神指导。', '2020-08-15 14:15:30', '2020-08-15 18:30:45', 3, '问题', 0),
(11, '关于数据库设计的疑问', '在设计用户表结构时，对于密码字段应该选择什么类型比较合适？需要考虑安全性问题。', '2020-08-15 11:40:20', '2020-08-15 16:55:10', 2, '问题', 0);
...
(12, 10, 4, '建议使用IDEA，它会自动帮你配置好大部分环境，对新手很友好。', '2020-08-15 16:20:35', 0),
(13, 11, 2, '密码建议用varchar类型，存储时一定要加密，推荐使用BCrypt。', '2020-08-15 17:10:45', 0),
