...
-- 初始化数据
-- ----------------------------
INSERT INTO `user`(`uid`, `uname`, `upwd`, `ustate`, `ucreatetime`, `level`, `phone`, `career`, `address`) VALUES (1, 'admin', '123456', 1, '2020-08-12 10:57:45', 0, '13800138000', '系统管理员', '北京市海淀区');
INSERT INTO `user`(`uid`, `uname`, `upwd`, `ustate`, `ucreatetime`, `level`, `phone`, `career`, `address`) VALUES (2, 'u1', '123456', 1, '2020-08-12 10:57:45', 1, '13800138001', '软件工程师', '北京市朝阳区');
INSERT INTO `user`(`uid`, `uname`, `upwd`, `ustate`, `ucreatetime`, `level`, `phone`, `career`, `address`) VALUES (3, 'u2', '123456', 1, '2020-08-13 09:30:00', 1, '13800138002', '产品经理', '上海市浦东新区');
INSERT INTO `user`(`uid`, `uname`, `upwd`, `ustate`, `ucreatetime`, `level`, `phone`, `career`, `address`) VALUES (4, 'u3', '123456', 1, '2020-08-14 14:20:30', 1, '13800138003', '设计师', '广州市天河区');
