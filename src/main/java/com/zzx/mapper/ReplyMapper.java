...
public interface ReplyMapper {
     ...
     * @param rid 回复ID
     * @param uid 用户ID
     * @return 1表示是创建者，0表示不是
     */
    int isReplyCreator(@Param("rid") Long rid, @Param("uid") Long uid);
     ...
     * @param rid 回复ID
     * @param uid 用户ID
     * @return 1表示是帖子创建者，0表示不是
     */
    int isPostCreatorByReplyId(@Param("rid") Long rid, @Param("uid") Long uid);
}
